...
ENDSUBJECT;
		...
		$email_body = <<<ENDBODY
This email IS NOT sent by the authors of Akeeba Subscriptions. It is sent automatically
...
Your site has determined that there is an updated version of Akeeba Subscriptions
